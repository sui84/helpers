...
namespace Common.Utils.Utfs
{
    public class Win32Api
    {
        ...
        public const UInt32 USN_REASON_TRANSACTED_CHANGE = 0x00400000;
        ...
        [DllImport("kernel32", EntryPoint = "FileTimeToLocalFileTime")]
        ...
        public static extern int FileTimeToSystemTime([In] ref FILETIME lpFileTime,ref DateTime lpSystemTime);
        ...
        public class UsnEntry : IComparable<UsnEntry>
        {
            ...
            private const int DateTime_OFFSET = 32; // add
            ...
            private Int64 _cdatetime;
            public Int64 ChangeDateTime
            {
            ...
            public UsnEntry(IntPtr ptrToUsnRecord)
            {
                ...
                _cdatetime = (Int64)Marshal.ReadInt64(ptrToUsnRecord, DateTime_OFFSET);
